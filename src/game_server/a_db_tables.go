...
type dbPlayerExpeditionCommonData struct{
	NoNewbee int32
}
func (this* dbPlayerExpeditionCommonData)from_pb(pb *db.PlayerExpeditionCommon){
	if pb == nil {
		return
	}
	this.NoNewbee = pb.GetNoNewbee()
	return
}
func (this* dbPlayerExpeditionCommonData)to_pb()(pb *db.PlayerExpeditionCommon){
	pb = &db.PlayerExpeditionCommon{}
	pb.NoNewbee = proto.Int32(this.NoNewbee)
	return
}
func (this* dbPlayerExpeditionCommonData)clone_to(d *dbPlayerExpeditionCommonData){
	d.NoNewbee = this.NoNewbee
	return
}
...
type dbPlayerSurfaceData struct{
	Data []byte
}
func (this* dbPlayerSurfaceData)from_pb(pb *db.PlayerSurface){
	if pb == nil {
		return
	}
	this.Data = pb.GetData()
...
func (this* dbPlayerSurfaceData)to_pb()(pb *db.PlayerSurface){
	pb = &db.PlayerSurface{}
	pb.Data = this.Data
	return
}
func (this* dbPlayerSurfaceData)clone_to(d *dbPlayerSurfaceData){
	d.Data = make([]byte, len(this.Data))
	for _ii, _vv := range this.Data {
		d.Data[_ii]=_vv
	}
...
type dbPlayerSpaceCommonData struct{
	BeFocusNum int32
	Gender int32
	FashionIds []int32
}
func (this* dbPlayerSpaceCommonData)from_pb(pb *db.PlayerSpaceCommon){
	if pb == nil {
		this.FashionIds = make([]int32,0)
		return
	}
	this.BeFocusNum = pb.GetBeFocusNum()
	this.Gender = pb.GetGender()
	this.FashionIds = make([]int32,len(pb.GetFashionIds()))
	for i, v := range pb.GetFashionIds() {
		this.FashionIds[i] = v
	}
	return
}
func (this* dbPlayerSpaceCommonData)to_pb()(pb *db.PlayerSpaceCommon){
	pb = &db.PlayerSpaceCommon{}
	pb.BeFocusNum = proto.Int32(this.BeFocusNum)
	pb.Gender = proto.Int32(this.Gender)
	pb.FashionIds = make([]int32, len(this.FashionIds))
	for i, v := range this.FashionIds {
		pb.FashionIds[i]=v
	}
	return
}
func (this* dbPlayerSpaceCommonData)clone_to(d *dbPlayerSpaceCommonData){
	d.BeFocusNum = this.BeFocusNum
	d.Gender = this.Gender
	d.FashionIds = make([]int32, len(this.FashionIds))
	for _ii, _vv := range this.FashionIds {
		d.FashionIds[_ii]=_vv
	}
	return
}
...
type dbPlayerOtherCatPictureUnlockData struct{
	PlayerCatId int64
}
func (this* dbPlayerOtherCatPictureUnlockData)from_pb(pb *db.PlayerOtherCatPictureUnlock){
	if pb == nil {
		return
	}
...
func (this* dbPlayerOtherCatPictureUnlockData)to_pb()(pb *db.PlayerOtherCatPictureUnlock){
	pb = &db.PlayerOtherCatPictureUnlock{}
	pb.PlayerCatId = proto.Int64(this.PlayerCatId)
	return
}
func (this* dbPlayerOtherCatPictureUnlockData)clone_to(d *dbPlayerOtherCatPictureUnlockData){
...
type dbPlayerExpeditionCommonColumn struct{
	m_row *dbPlayerRow
	m_data *dbPlayerExpeditionCommonData
	m_changed bool
}
func (this *dbPlayerExpeditionCommonColumn)load(data []byte)(err error){
	if data == nil || len(data) == 0 {
		this.m_data = &dbPlayerExpeditionCommonData{}
		this.m_changed = false
		return nil
	}
	pb := &db.PlayerExpeditionCommon{}
...
func (this *dbPlayerExpeditionCommonColumn)save( )(data []byte,err error){
	pb:=this.m_data.to_pb()
	data, err = proto.Marshal(pb)
	if err != nil {
		log.Error("Marshal %v", this.m_row.GetPlayerId())
...
func (this *dbPlayerExpeditionCommonColumn)Get( )(v *dbPlayerExpeditionCommonData ){
	this.m_row.m_lock.UnSafeRLock("dbPlayerExpeditionCommonColumn.Get")
	defer this.m_row.m_lock.UnSafeRUnlock()
	v=&dbPlayerExpeditionCommonData{}
	this.m_data.clone_to(v)
	return
}
func (this *dbPlayerExpeditionCommonColumn)Set(v dbPlayerExpeditionCommonData ){
	this.m_row.m_lock.UnSafeLock("dbPlayerExpeditionCommonColumn.Set")
	defer this.m_row.m_lock.UnSafeUnlock()
	this.m_data=&dbPlayerExpeditionCommonData{}
	v.clone_to(this.m_data)
	this.m_changed=true
...
func (this *dbPlayerExpeditionCommonColumn)GetNoNewbee( )(v int32 ){
	this.m_row.m_lock.UnSafeRLock("dbPlayerExpeditionCommonColumn.GetNoNewbee")
	defer this.m_row.m_lock.UnSafeRUnlock()
	v = this.m_data.NoNewbee
	return
}
func (this *dbPlayerExpeditionCommonColumn)SetNoNewbee(v int32){
	this.m_row.m_lock.UnSafeLock("dbPlayerExpeditionCommonColumn.SetNoNewbee")
	defer this.m_row.m_lock.UnSafeUnlock()
	this.m_data.NoNewbee = v
	this.m_changed = true
	return
}
...
type dbPlayerSurfaceColumn struct{
	m_row *dbPlayerRow
	m_data *dbPlayerSurfaceData
	m_changed bool
}
func (this *dbPlayerSurfaceColumn)load(data []byte)(err error){
	if data == nil || len(data) == 0 {
		this.m_data = &dbPlayerSurfaceData{}
		this.m_changed = false
		return nil
	}
	pb := &db.PlayerSurface{}
...
func (this *dbPlayerSurfaceColumn)save( )(data []byte,err error){
	pb:=this.m_data.to_pb()
	data, err = proto.Marshal(pb)
	if err != nil {
		log.Error("Marshal %v", this.m_row.GetPlayerId())
...
func (this *dbPlayerSurfaceColumn)Get( )(v *dbPlayerSurfaceData ){
	this.m_row.m_lock.UnSafeRLock("dbPlayerSurfaceColumn.Get")
	defer this.m_row.m_lock.UnSafeRUnlock()
	v=&dbPlayerSurfaceData{}
	this.m_data.clone_to(v)
	return
}
func (this *dbPlayerSurfaceColumn)Set(v dbPlayerSurfaceData ){
	this.m_row.m_lock.UnSafeLock("dbPlayerSurfaceColumn.Set")
	defer this.m_row.m_lock.UnSafeUnlock()
	this.m_data=&dbPlayerSurfaceData{}
	v.clone_to(this.m_data)
	this.m_changed=true
...
func (this *dbPlayerSurfaceColumn)GetData( )(v []byte){
	this.m_row.m_lock.UnSafeRLock("dbPlayerSurfaceColumn.GetData")
	defer this.m_row.m_lock.UnSafeRUnlock()
	v = make([]byte, len(this.m_data.Data))
	for _ii, _vv := range this.m_data.Data {
		v[_ii]=_vv
...
func (this *dbPlayerSurfaceColumn)SetData(v []byte){
	this.m_row.m_lock.UnSafeLock("dbPlayerSurfaceColumn.SetData")
	defer this.m_row.m_lock.UnSafeUnlock()
	this.m_data.Data = make([]byte, len(v))
	for _ii, _vv := range v {
		this.m_data.Data[_ii]=_vv
...
type dbPlayerSpaceCommonColumn struct{
	m_row *dbPlayerRow
	m_data *dbPlayerSpaceCommonData
	m_changed bool
}
func (this *dbPlayerSpaceCommonColumn)load(data []byte)(err error){
	if data == nil || len(data) == 0 {
		this.m_data = &dbPlayerSpaceCommonData{}
		this.m_changed = false
		return nil
	}
	pb := &db.PlayerSpaceCommon{}
...
func (this *dbPlayerSpaceCommonColumn)save( )(data []byte,err error){
	pb:=this.m_data.to_pb()
	data, err = proto.Marshal(pb)
	if err != nil {
		log.Error("Marshal %v", this.m_row.GetPlayerId())
...
func (this *dbPlayerSpaceCommonColumn)Get( )(v *dbPlayerSpaceCommonData ){
	this.m_row.m_lock.UnSafeRLock("dbPlayerSpaceCommonColumn.Get")
	defer this.m_row.m_lock.UnSafeRUnlock()
	v=&dbPlayerSpaceCommonData{}
	this.m_data.clone_to(v)
	return
}
func (this *dbPlayerSpaceCommonColumn)Set(v dbPlayerSpaceCommonData ){
	this.m_row.m_lock.UnSafeLock("dbPlayerSpaceCommonColumn.Set")
	defer this.m_row.m_lock.UnSafeUnlock()
	this.m_data=&dbPlayerSpaceCommonData{}
	v.clone_to(this.m_data)
	this.m_changed=true
...
func (this *dbPlayerSpaceCommonColumn)GetBeFocusNum( )(v int32 ){
	this.m_row.m_lock.UnSafeRLock("dbPlayerSpaceCommonColumn.GetBeFocusNum")
	defer this.m_row.m_lock.UnSafeRUnlock()
	v = this.m_data.BeFocusNum
	return
}
func (this *dbPlayerSpaceCommonColumn)SetBeFocusNum(v int32){
	this.m_row.m_lock.UnSafeLock("dbPlayerSpaceCommonColumn.SetBeFocusNum")
	defer this.m_row.m_lock.UnSafeUnlock()
	this.m_data.BeFocusNum = v
	this.m_changed = true
	return
}
func (this *dbPlayerSpaceCommonColumn)IncbyBeFocusNum(v int32)(r int32){
	this.m_row.m_lock.UnSafeLock("dbPlayerSpaceCommonColumn.IncbyBeFocusNum")
	defer this.m_row.m_lock.UnSafeUnlock()
	this.m_data.BeFocusNum += v
	this.m_changed = true
	return this.m_data.BeFocusNum
}
func (this *dbPlayerSpaceCommonColumn)GetGender( )(v int32 ){
	this.m_row.m_lock.UnSafeRLock("dbPlayerSpaceCommonColumn.GetGender")
	defer this.m_row.m_lock.UnSafeRUnlock()
	v = this.m_data.Gender
	return
}
func (this *dbPlayerSpaceCommonColumn)SetGender(v int32){
	this.m_row.m_lock.UnSafeLock("dbPlayerSpaceCommonColumn.SetGender")
	defer this.m_row.m_lock.UnSafeUnlock()
	this.m_data.Gender = v
	this.m_changed = true
	return
}
func (this *dbPlayerSpaceCommonColumn)GetFashionIds( )(v []int32 ){
	this.m_row.m_lock.UnSafeRLock("dbPlayerSpaceCommonColumn.GetFashionIds")
	defer this.m_row.m_lock.UnSafeRUnlock()
	v = make([]int32, len(this.m_data.FashionIds))
	for _ii, _vv := range this.m_data.FashionIds {
		v[_ii]=_vv
	}
	return
}
func (this *dbPlayerSpaceCommonColumn)SetFashionIds(v []int32){
	this.m_row.m_lock.UnSafeLock("dbPlayerSpaceCommonColumn.SetFashionIds")
	defer this.m_row.m_lock.UnSafeUnlock()
	this.m_data.FashionIds = make([]int32, len(v))
	for _ii, _vv := range v {
		this.m_data.FashionIds[_ii]=_vv
	}
	this.m_changed = true
	return
}
...
type dbPlayerOtherCatPictureUnlockColumn struct{
	m_row *dbPlayerRow
	m_data map[int64]*dbPlayerOtherCatPictureUnlockData
	m_changed bool
}
func (this *dbPlayerOtherCatPictureUnlockColumn)load(data []byte)(err error){
	if data == nil || len(data) == 0 {
		this.m_changed = false
		return nil
	}
	pb := &db.PlayerOtherCatPictureUnlockList{}
	err = proto.Unmarshal(data, pb)
	if err != nil {
		log.Error("Unmarshal %v", this.m_row.GetPlayerId())
		return
	...
	for _, v := range pb.List {
		d := &dbPlayerOtherCatPictureUnlockData{}
		d.from_pb(v)
...
func (this *dbPlayerOtherCatPictureUnlockColumn)save( )(data []byte,err error){
	pb := &db.PlayerOtherCatPictureUnlockList{}
	pb.List=make([]*db.PlayerOtherCatPictureUnlock,len(this.m_data))
	i:=0
	for _, v := range this.m_data {
		pb.List[i] = v.to_pb()
		i++
...
func (this *dbPlayerOtherCatPictureUnlockColumn)HasIndex(id int64)(has bool){
	this.m_row.m_lock.UnSafeRLock("dbPlayerOtherCatPictureUnlockColumn.HasIndex")
	defer this.m_row.m_lock.UnSafeRUnlock()
	_, has = this.m_data[id]
	return
}
func (this *dbPlayerOtherCatPictureUnlockColumn)GetAllIndex()(list []int64){
	this.m_row.m_lock.UnSafeRLock("dbPlayerOtherCatPictureUnlockColumn.GetAllIndex")
	defer this.m_row.m_lock.UnSafeRUnlock()
	list = make([]int64, len(this.m_data))
	i := 0
	for k, _ := range this.m_data {
...
func (this *dbPlayerOtherCatPictureUnlockColumn)GetAll()(list []dbPlayerOtherCatPictureUnlockData){
	this.m_row.m_lock.UnSafeRLock("dbPlayerOtherCatPictureUnlockColumn.GetAll")
	defer this.m_row.m_lock.UnSafeRUnlock()
	list = make([]dbPlayerOtherCatPictureUnlockData, len(this.m_data))
	i := 0
	for _, v := range this.m_data {
		v.clone_to(&list[i])
		i++
...
func (this *dbPlayerOtherCatPictureUnlockColumn)Get(id int64)(v *dbPlayerOtherCatPictureUnlockData){
	this.m_row.m_lock.UnSafeRLock("dbPlayerOtherCatPictureUnlockColumn.Get")
	defer this.m_row.m_lock.UnSafeRUnlock()
	d := this.m_data[id]
	if d==nil{
		return nil
	}
	v=&dbPlayerOtherCatPictureUnlockData{}
	d.clone_to(v)
	return
}
func (this *dbPlayerOtherCatPictureUnlockColumn)Set(v dbPlayerOtherCatPictureUnlockData)(has bool){
	this.m_row.m_lock.UnSafeLock("dbPlayerOtherCatPictureUnlockColumn.Set")
	defer this.m_row.m_lock.UnSafeUnlock()
...
func (this *dbPlayerOtherCatPictureUnlockColumn)Add(v *dbPlayerOtherCatPictureUnlockData)(ok bool){
	this.m_row.m_lock.UnSafeLock("dbPlayerOtherCatPictureUnlockColumn.Add")
	defer this.m_row.m_lock.UnSafeUnlock()
...
func (this *dbPlayerOtherCatPictureUnlockColumn)Remove(id int64){
	this.m_row.m_lock.UnSafeLock("dbPlayerOtherCatPictureUnlockColumn.Remove")
	defer this.m_row.m_lock.UnSafeUnlock()
	_, has := this.m_data[id]
	if has {
		delete(this.m_data,id)
...
func (this *dbPlayerOtherCatPictureUnlockColumn)Clear(){
	this.m_row.m_lock.UnSafeLock("dbPlayerOtherCatPictureUnlockColumn.Clear")
	defer this.m_row.m_lock.UnSafeUnlock()
	this.m_data=make(map[int64]*dbPlayerOtherCatPictureUnlockData)
	this.m_changed = true
	return
}
func (this *dbPlayerOtherCatPictureUnlockColumn)NumAll()(n int32){
	this.m_row.m_lock.UnSafeRLock("dbPlayerOtherCatPictureUnlockColumn.NumAll")
	defer this.m_row.m_lock.UnSafeRUnlock()
	return int32(len(this.m_data))
}
type dbPlayerRow struct {
	...
	SpaceCommon dbPlayerSpaceCommonColumn
	FocusPlayers dbPlayerFocusPlayerColumn
	MyPictureDatas dbPlayerMyPictureDataColumn
	OtherCatPictureUnlocks dbPlayerOtherCatPictureUnlockColumn
}
func new_dbPlayerRow(table *dbPlayerTable, PlayerId int32) (r *dbPlayerRow) {
	...
	this.ExpeditionCommon.m_row=this
	this.ExpeditionCommon.m_data=&dbPlayerExpeditionCommonData{}
	...
	this.SpaceCommon.m_row=this
	this.SpaceCommon.m_data=&dbPlayerSpaceCommonData{}
	...
	this.OtherCatPictureUnlocks.m_row=this
	this.OtherCatPictureUnlocks.m_data=make(map[int64]*dbPlayerOtherCatPictureUnlockData)
	return this
}
...
func (this *dbPlayerRow) save_data(release bool) (err error, released bool, state int32, update_string string, args []interface{}) {
	...
	if this.m_new {
		...
		dExpeditionCommon,db_err:=this.ExpeditionCommon.save()
		if db_err!=nil{
			log.Error("insert save ExpeditionCommon failed")
			return db_err,false,0,"",nil
		}
		db_args.Push(dExpeditionCommon)
		...
		dSurface,db_err:=this.Surface.save()
		if db_err!=nil{
			log.Error("insert save Surface failed")
			return db_err,false,0,"",nil
		}
		db_args.Push(dSurface)
		dSpaceCommon,db_err:=this.SpaceCommon.save()
		if db_err!=nil{
			log.Error("insert save SpaceCommon failed")
			return db_err,false,0,"",nil
		}
		db_args.Push(dSpaceCommon)
		...
		dOtherCatPictureUnlocks,db_err:=this.OtherCatPictureUnlocks.save()
		if db_err!=nil{
			log.Error("insert save OtherCatPictureUnlock failed")
			return db_err,false,0,"",nil
		}
		db_args.Push(dOtherCatPictureUnlocks)
		args=db_args.GetArgs()
		state = 1
	} else {
		if this.m_UniqueId_changed||this.m_Account_changed||this.m_Name_changed||this.m_Token_changed||this.m_Level_changed||this.Info.m_changed||this.Stages.m_changed||this.ChapterUnLock.m_changed||this.Items.m_changed||this.Areas.m_changed||this.BuildingCommon.m_changed||this.Buildings.m_changed||this.BuildingDepots.m_changed||this.DepotBuildingFormulas.m_changed||this.MakingFormulaBuildings.m_changed||this.Crops.m_changed||this.Cats.m_changed||this.CatHouses.m_changed||this.Shops.m_changed||this.ShopItems.m_changed||this.ShopLimitedInfos.m_changed||this.Chests.m_changed||this.PayBacks.m_changed||this.Options.m_changed||this.TaskCommon.m_changed||this.Tasks.m_changed||this.FinishedTasks.m_changed||this.DailyTaskAllDailys.m_changed||this.SevenActivitys.m_changed||this.SignInfo.m_changed||this.FriendRelative.m_changed||this.Friends.m_changed||this.FriendRecommends.m_changed||this.FriendAsks.m_changed||this.FriendReqs.m_changed||this.FriendPoints.m_changed||this.FriendChatUnreadIds.m_changed||this.FriendChatUnreadMessages.m_changed||this.CustomData.m_changed||this.ChaterOpenRequest.m_changed||this.ExpeditionCommon.m_changed||this.Expeditions.m_changed||this.HandbookItems.m_changed||this.HeadItems.m_changed||this.Activitys.m_changed||this.SuitAwards.m_changed||this.Zans.m_changed||this.Foster.m_changed||this.FosterCats.m_changed||this.FosterCatOnFriends.m_changed||this.FosterFriendCats.m_changed||this.Chats.m_changed||this.Anouncement.m_changed||this.FirstDrawCards.m_changed||this.TalkForbid.m_changed||this.ServerRewards.m_changed||this.MailCommon.m_changed||this.Mails.m_changed||this.Sign.m_changed||this.SevenDays.m_changed||this.PayCommon.m_changed||this.Pays.m_changed||this.GuideData.m_changed||this.ActivityDatas.m_changed||this.SysMail.m_changed||this.Surface.m_changed||this.SpaceCommon.m_changed||this.FocusPlayers.m_changed||this.MyPictureDatas.m_changed||this.OtherCatPictureUnlocks.m_changed{
			...
			if this.ExpeditionCommon.m_changed{
				update_string+="ExpeditionCommon=?,"
				dExpeditionCommon,err:=this.ExpeditionCommon.save()
				if err!=nil{
					log.Error("update save ExpeditionCommon failed")
					return err,false,0,"",nil
				}
				db_args.Push(dExpeditionCommon)
			}
			...
			if this.Surface.m_changed{
				update_string+="Surface=?,"
				dSurface,err:=this.Surface.save()
				if err!=nil{
					log.Error("update save Surface failed")
					return err,false,0,"",nil
				}
				db_args.Push(dSurface)
			}
			if this.SpaceCommon.m_changed{
				update_string+="SpaceCommon=?,"
				dSpaceCommon,err:=this.SpaceCommon.save()
				if err!=nil{
					log.Error("update save SpaceCommon failed")
					return err,false,0,"",nil
				}
				db_args.Push(dSpaceCommon)
			}
			...
			if this.OtherCatPictureUnlocks.m_changed{
				update_string+="OtherCatPictureUnlocks=?,"
				dOtherCatPictureUnlocks,err:=this.OtherCatPictureUnlocks.save()
				if err!=nil{
					log.Error("insert save OtherCatPictureUnlock failed")
					return err,false,0,"",nil
				}
	...
	this.SpaceCommon.m_changed = false
	this.FocusPlayers.m_changed = false
	this.MyPictureDatas.m_changed = false
	this.OtherCatPictureUnlocks.m_changed = false
	if release && this.m_loaded {
...
func (this *dbPlayerTable) check_create_table() (err error) {
	...
	_, hasExpeditionCommon := columns["ExpeditionCommon"]
	if !hasExpeditionCommon {
		_, err = this.m_dbc.Exec("ALTER TABLE Players ADD COLUMN ExpeditionCommon LONGBLOB")
		if err != nil {
			log.Error("ADD COLUMN ExpeditionCommon failed")
			return
		}
	}
	...
	_, hasSurface := columns["Surface"]
	if !hasSurface {
		_, err = this.m_dbc.Exec("ALTER TABLE Players ADD COLUMN Surface LONGBLOB")
		if err != nil {
			log.Error("ADD COLUMN Surface failed")
			return
		}
	}
	_, hasSpaceCommon := columns["SpaceCommon"]
	if !hasSpaceCommon {
		_, err = this.m_dbc.Exec("ALTER TABLE Players ADD COLUMN SpaceCommon LONGBLOB")
		if err != nil {
			log.Error("ADD COLUMN SpaceCommon failed")
			return
		}
	}
	...
	_, hasOtherCatPictureUnlock := columns["OtherCatPictureUnlocks"]
	if !hasOtherCatPictureUnlock {
		_, err = this.m_dbc.Exec("ALTER TABLE Players ADD COLUMN OtherCatPictureUnlocks LONGBLOB")
		if err != nil {
			log.Error("ADD COLUMN OtherCatPictureUnlocks failed")
			return
		}
	}
	return
...
func (this *dbPlayerTable) Preload() (err error) {
	...
	for r.Next() {
		...
		err = row.ExpeditionCommon.load(dExpeditionCommon)
		if err != nil {
			log.Error("ExpeditionCommon %v", PlayerId)
			return
		}
		...
		err = row.SpaceCommon.load(dSpaceCommon)
		if err != nil {
			log.Error("SpaceCommon %v", PlayerId)
			return
		}
		...
		err = row.OtherCatPictureUnlocks.load(dOtherCatPictureUnlocks)
		if err != nil {
			log.Error("OtherCatPictureUnlocks %v", PlayerId)
			return
		}

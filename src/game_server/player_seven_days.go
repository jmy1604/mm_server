...
func (this *Player) seven_days_data() int32 {
	...
	this.Send(uint16(msg_client_message.S2CSevenDaysDataResponse_ProtoID), response)
...
func (this *Player) seven_days_award() int32 {
	...
	this.Send(uint16(msg_client_message.S2CSevenDaysAwardResponse_ProtoID), response)

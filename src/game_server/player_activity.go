...
type ActivityManager struct {
	data_map map[int32]*tables.XmlActivityItem
	locker   sync.RWMutex
}
...
func (this *ActivityManager) Run() {
	...
	if this.data_map == nil {
		this.data_map = make(map[int32]*tables.XmlActivityItem)
	}
...
func (this *ActivityManager) GetActivitysByEvent(event_type int32) (items []*tables.XmlActivityItem) {
	this.locker.RLock()
	defer this.locker.RUnlock()
...
func (this *Player) activity_get_one_charge(bundle_id string) (int32, *tables.XmlSubActivityItem) {
...
// 充值
func (this *Player) activity_update_one_charge(id int32, sa *tables.XmlSubActivityItem) {
...
// 活动更新
func (this *Player) activity_update(a *tables.XmlActivityItem, param1, param2, param3, param4 int32) {
